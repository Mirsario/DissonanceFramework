...
{
	public abstract class CppGeneratorBase : Generator
	{
		...
		public CppGeneratorBase()
		{
			...
			Options.Plugins.Insert(0, new StructToVoidConverter());
			Options.Plugins.Add(MacroPlugin = new MacroConverterPlugin());
		}

		public abstract CSharpCompilation GetCSharpCompilation();
